...
const socialLinks = [
  {
    ...
    icon: (
      <svg className="h-[32px] w-[32px]" fill="#3b5998" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    icon: (
      <svg className="h-[32px] w-[32px]" fill="#E1306C" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    icon: (
      <svg className="h-[32px] w-[32px]" fill="#0077B5" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    icon: (
      <svg className="h-[32px] w-[32px]" fill="#E60023" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    icon: (
      <svg className="h-[32px] w-[32px]" fill="#FF0000" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    icon: (
      <svg className="h-[32px] w-[32px]" fill="#25d366" viewBox="0 0 24 24">
...
export default function Footer() {
  return (
    <footer style={{ background: "#1a1a2e" }} className="mt-auto text-white">
      {/* Main footer body */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col items-start gap-4">
            ...
            <p className="text-[13px] text-gray-300 leading-relaxed">
              Kurumsal Promosyon Ürünleri ve<br />Reklam Promosyonları
            </p>
            <div>
              <p className="text-[11px] text-gray-400 font-medium mb-0.5">Türkiye&apos;nin her yerinden</p>
              <a href="tel:4441030" className="text-[18px] font-bold text-white hover:text-[#cc0636] transition-colors">
                444 10 30
              </a>
            </div>
            <div>
              <p className="text-[11px] text-gray-400 font-medium mb-0.5">WhatsApp Sipariş</p>
              <a
                href="https://wa.me/905442338003"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[15px] font-bold text-white hover:text-green-400 transition-colors"
              >
                0544 233 80 03
              </a>
            </div>
          ...
          <div>
            <h3 className="text-[13px] font-bold text-white uppercase tracking-wider mb-4 pb-2 border-b border-white/10">
              Popüler Ürünler
            </h3>
            <ul className="space-y-2">
              {popularProducts.map((p) => (
                <li key={p.href}>
                  <Link
                    href={p.href}
                    className="text-[13px] text-gray-300 hover:text-[#cc0636] transition-colors flex items-center gap-1.5"
                  >
                    <span className="text-[#cc0636] text-[10px]">▶</span>
                    {p.name}
                  </Link>
                </li>
              ))}
      ...
      {/* Bottom bar */}
      <div style={{ background: "#111122", borderTop: "1px solid rgba(255,255,255,0.07)" }}>
        <div className="max-w-[1320px] mx-auto px-4 py-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-[12px] text-gray-400">
            © {new Date().getFullYear()} Pir Reklam Promosyon. Tüm Hakları Saklıdır.
          </p>
          <a
          ...
          >
            Google&apos;da Yorum Yapabilirsiniz ★
          </a>
        </div>
      </div>
    </footer>
